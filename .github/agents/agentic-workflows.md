...
- When creating or editing agentic workflow files via Copilot Chat/Cloud, only edit the markdown workflow file (`.md`); compile separately to update the corresponding `.lock.yml` before running.
